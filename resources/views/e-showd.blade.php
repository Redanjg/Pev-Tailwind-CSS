        ...
        <div class="container mx-auto">
            ...
            E-SHOW DIRECTORY
                ...
                <br>
                    ...
                    <a href="https://pevs.s3.ap-southeast-1.amazonaws.com/2024/E-DIRECTORY_PEVS24.pdf"><button type="button" class="px-6 sm:px-12 py-3.5 sm:py-4  text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm sm:text-lg px-5 py-2.5 text-center me-2 mb-2">View E-SHOW DIRECTORY
                        </button>
                    </a>
