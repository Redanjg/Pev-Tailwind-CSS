    ...
    <section id="about" style="background-image: linear-gradient(#a2e5f6, white);">
        ...
        <div class="container mx-auto">
            ...
            <div class="grid gird-row-2">
                ...
                <h3 class="text-center" style="font-style: italic; font-weight: 900; font-size: xx-large">OFFICIAL PEVS PARTNERS
                </h3>
                <center>
                ...
                <div class="grid-row mt-5">
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12 mx-auto mt-5">
                        <img src="https://pevs.s3.ap-southeast-1.amazonaws.com/partners.png" alt=""
